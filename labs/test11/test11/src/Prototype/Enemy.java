...
public class Enemy extends AbstractGameObject {
    ...
    public Enemy(Integer id, Integer positionX, Integer positionY, String textureFile, Boolean isVisible,
    ...
    public AbstractGameObject Clone() throws IOException {
        Enemy e = new Enemy(this.id + 1, this.positionX, this.positionY, "", this.isVisible,
