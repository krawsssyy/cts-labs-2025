...
public class Obstacle extends AbstractGameObject {
    ...
    public Obstacle(Integer id, Integer positionX, Integer positionY, String textureFile, Boolean isVisible,
    ...
    public AbstractGameObject Clone() throws IOException {
        Obstacle o = new Obstacle(this.id + 1, this.positionX, this.positionY, "", this.isVisible,
