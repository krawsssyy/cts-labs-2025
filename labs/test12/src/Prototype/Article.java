...
public class Article extends AbstractWebpage {

    public Article(Integer id, String title, String content, String author, String[] tags,
    ...
    public boolean Publish() {
        ...
        System.out.println("[*] Published article with id " + this.id);
        return true;
    }
    ...
    public boolean Unpublish() {
        ...
        System.out.println("[*] Unpublished article with id " + this.id);
        return true;
    }

    @Override
    public AbstractWebpage Clone() {
        Article a = new Article(this.id + 1, this.title, this.content, this.author, this.tags,
                this.contentType, this.creationDate, this.modificationDate, this.isPublished, this.categories);
        a.SetData(this.htmlData);
        return a;
    }
}
