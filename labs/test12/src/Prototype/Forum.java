...
public class Forum extends AbstractWebpage {

    public Forum(Integer id, String title, String content, String author, String[] tags,
    ...
    public boolean Publish() {
        ...
        System.out.println("[*] Published forum with id " + this.id);
        return true;
    }
    ...
    public boolean Unpublish() {
        ...
        System.out.println("[*] Unpublished forum with id " + this.id);
        return true;
    }

    @Override
    public AbstractWebpage Clone() {
        Forum f = new Forum(this.id + 1, this.title, this.content, this.author, this.tags,
                this.contentType, this.creationDate, this.modificationDate, this.isPublished, this.categories);
        f.SetData(this.htmlData);
        return f;
    }
}
